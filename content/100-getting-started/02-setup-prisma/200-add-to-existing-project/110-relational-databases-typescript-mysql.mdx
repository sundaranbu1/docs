...
metaTitle: 'Add Prisma to an existing project using TypeScript and MySQL (15 min)'
metaDescription: 'Learn how to add Prisma to an existing TypeScript project by connecting it to your MySQL database and generating a Prisma Client for database access.'
